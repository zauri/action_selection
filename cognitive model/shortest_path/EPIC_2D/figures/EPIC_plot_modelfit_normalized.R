...
avg <- c(0.44,0.666,0.605,0.605,0.44,0.44,0.666,0.756,0.605,0.756,0.723,0.806,0.666,0.25,0.666,0.666)

# Plot model, c+k set
plot(xdata, model_ck, type='o', col='blue', pch=15, lty=3, ylim=c(0,1.2), lwd=2, 
...
points(xdata, k_set, col='green3', pch=16)
lines(xdata, k_set, col='green3', lty=1, lwd=2)

# Plot model without k
points(xdata, c_set, col='darkorange1', pch=17)
lines(xdata, c_set, col='darkorange1', lty=1, lwd=2)

# Plot greedy without params
points(xdata, no_params, col='dark magenta', pch=18)
lines(xdata, no_params, col='dark magenta', lty=3, lwd=2)
...
lines(xdata, model_ck, col='blue', lty=3, lwd=2)


# Plot legend in 3 columns
legend_order <- matrix(1:6, ncol=3, byrow=TRUE)

legend(2,1.23, c('c+k set', 'k set', 'c set', 'no parameters set','mean edit distance')[legend_order], 
       col=c('blue', 'green3', 'darkorange1', 'dark magenta', 'black')[legend_order], 
