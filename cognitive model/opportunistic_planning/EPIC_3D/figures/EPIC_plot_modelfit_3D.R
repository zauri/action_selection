...
model_ck <- c(0.33,0.6,0.5,0.5,0,0,0,0.5,0.25,0.71,0.33,0.44,0.8,0,0.8,0.6)
k_set <- c(0.67,0.6,0.5,0.5,0,0,0,0.5,0.25,0.71,0.33,0.44,0.8,0,0.8,0.6)
c_set <- c(0.67,0.6,0.25,0.5,0,0,0.6,0.5,0.5,0.71,0.33,0.67,0.8,0.5,0.8,0.8)
no_params <- c(0.67,0.8,0.5,0.5,0,0.33,0.6,0.5,0.5,0.71,0.33,0.67,0.6,0.5,0.8,0.8)
