...
\begin{tikzpicture}
	% set up grid
	\draw[step=1.0, black] (0,0) grid (10,8);
	...
	\node (T) [circle, draw=black, inner sep=1.5pt, minimum size=3pt, fill=blue!10] at (5,3) {T};
	...
	legend style={at={(0,-2.5)}, anchor=south west}]
	\addlegendimage{letter in legend=S, black}
	\addlegendimage{letter in legend=T, black}
