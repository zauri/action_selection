...
from opportunistic_planning import processing


def plot_dimensions(results_df, rnn=None):
...
def plot_comparison_to_baselines(results_median, cpt=None, rnn=None):
    # TODO: add save functionality
    
    IDs = results_median['ID']
