...
def predict_sequence(objects:list, coordinates:dict, start_coordinates:list, c:dict, k:dict, dimension=[3, ]) -> str:
    ''' Predicts sequence based on required objects, object coordinates, start coordinates of subject,
        ...
        Input: List of objects, dict: object coordinates (object identifier as keys, tuple of 3D coordinates as values), 
        start coordinates (list of 3D coordinate lists), 
        c (dict: object identifiers as keys, parameter value as values), 
        k (same format as c), dimension (in the form of [2,'xy'])
