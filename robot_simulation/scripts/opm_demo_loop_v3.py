...
class PickAndPlaceDemo:
    ...
    def __init__(self):
        ...
        self.object_spawning_poses: List[Pose] = [
            Pose([0.15, -0.4, 0.1], [0, 0, 1, 0], frame=sink_area_surface_frame), # breakfast-cereal
            Pose([0.07, -0.35, 0.1], [0, 0, 1, 0], frame=sink_area_surface_frame), # cup
            Pose([0.2, -0.15, 0.1], [0, 0, 1, 0], frame=sink_area_surface_frame), # bowl
            Pose([0.2, -0.35, 0.05], [0, 0, 1, 0], frame=sink_area_surface_frame), # spoon
            Pose([0.0, 0.5, 0.05], [0, 0, 0, 1], frame=kitchen_island_surface_frame) # milk              
        ]
...
if __name__ == "__main__":
    ...
    with open('opm_demo_log_v3.txt', 'a') as file:
